...
if instance_exists(obj_DC_player_camera) && instance_exists(obj_DC_player){
	 _x = clamp(obj_DC_player_camera.x-view_width/2,0,room_width-view_width);
	 _y = clamp(obj_DC_player_camera.y-view_height/2,0,room_height-view_height);
...
if(obj_DC_player.level_up || game_over){
