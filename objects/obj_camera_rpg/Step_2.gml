...
if instance_exists(obj_player_rpg_camera) && instance_exists(obj_player_rpg){
	 _x = clamp(obj_player_rpg_camera.x-view_width/2,0,room_width-view_width);
	 _y = clamp(obj_player_rpg_camera.y-view_height/2,0,room_height-view_height);
